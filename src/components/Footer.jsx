...
function Footer() {
  return (
    <div 
      ...
      data-scroll-section
      data-scroll-speed=".9"
      className="w-full h-screen rounded-tl-3xl rounded-tr-3xl bg-stone-400 flex items-center justify-center"
    >
      <div className="w-1/2 h-full flex flex-col justify-between items-center">
        <h1 className="text-black text-[7vw] font-bold py-20 px-20 leading-none tracking-tighter">
          EYE-OPENING
        </h1>
        <div className=" w-full px-14 py-10 text-black ">
          <svg
            width="72"
            height="30"
            viewBox="0 0 72 30"
      ...
      <div className="w-1/2 border-l-[2px] border-zinc-500 pl-4 h-full">
        <h1 className="text-black text-7xl font-bold py-20  leading-none tracking-tighter ">
          PRESENTATIONS
        </h1>
        <div className="flex gap-[28vw] items-center justify-center">
          <div className="flex flex-col text-black text-xl font-normal gap-2">
